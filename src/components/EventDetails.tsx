...
function CardArch({ children, delay, variant }: { children: React.ReactNode; delay?: number; variant?: 'left' | 'right' | 'up' }) {
  return (
    <ScrollAnimator delay={delay} variant={variant}>
      <div className="relative bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border border-gold/20">
    ...
    <section className="py-16 px-6 bg-gradient-navy text-white geometric-overlay">
      <div className="relative z-10 max-w-lg mx-auto text-center">
        <ScrollAnimator>
          ...
          <h2 className="font-heading text-2xl md:text-3xl text-gold mt-4 mb-2">
            Detail Acara
          </h2>
        ...
        <div className="space-y-6">
          ...
          <CardArch delay={100} variant="left">
            ...
            <h3 className="font-heading text-lg text-gold mb-2">Tanggal</h3>
            <p className="text-white text-lg font-heading">{EVENT_INFO.dateFormatted}</p>
            <p className="text-gold-light/70 text-sm mt-1 font-arabic">{EVENT_INFO.dateHijri}</p>
          </CardArch>
          ...
          <CardArch delay={200} variant="right">
            ...
            <h3 className="font-heading text-lg text-gold mb-2">Waktu</h3>
            <p className="text-white text-lg">{EVENT_INFO.time}</p>
          </CardArch>
          ...
          <CardArch delay={300} variant="left">
            ...
            <h3 className="font-heading text-lg text-gold mb-2">Tempat</h3>
            <p className="text-white text-lg font-heading">{EVENT_INFO.venue}</p>
            <p className="text-white/70 text-sm mt-2 leading-relaxed">{EVENT_INFO.address}</p>
          </CardArch>
        </div>
      </div>
    </section>
